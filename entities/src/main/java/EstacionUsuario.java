...
public class EstacionUsuario implements java.io.Serializable {
	...
	public EstacionUsuario(EstacionUsuarioId id, Estacion estacion, Usuario usuario, String creacionUsuario,
	...
	public EstacionUsuarioId getId() {
		return this.id;
	}

	public void setId(EstacionUsuarioId id) {
		this.id = id;
	}
