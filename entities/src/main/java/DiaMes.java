...
public class DiaMes implements java.io.Serializable {
	...
	public DiaMes(int idDiaMes, String descripcion, int diaSemana, int semanaMes, String creacionUsuario,
	...
	public int getIdDiaMes() {
		return this.idDiaMes;
	}

	public void setIdDiaMes(int idDiaMes) {
		this.idDiaMes = idDiaMes;
	}
